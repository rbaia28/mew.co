...
class Pokemon 
{
	...
	public function __construct(int $id, int $uuid, int $dex_id, string $nickname, bool $is_shiny, int $cp, int $current_level, int $location_id, int $trainer_id, bool $is_archived) {
		$this->id = $id;
		$this->uuid = $uuid;
		$this->dex_id = $dex_id;
